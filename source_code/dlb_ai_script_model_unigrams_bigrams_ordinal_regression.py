...
Model with unigrams and bigrams modeling with ordinal regression
"""
...
print('==================================================================')
print('Mean Absolute Error of MultinomialNB',
...
# Creating and evaluating an ordinal regression model LogisticAT (All-Threshold variant))

y_train_64 = y_train.to_numpy(dtype = 'int64')

regressor = mord.LogisticAT(alpha = 1.)
regressor.fit(X_train, y_train_64)
y_pred_o = regressor.predict(X_test)

conf_mat = confusion_matrix(y_test, y_pred_o)
fig, ax = plt.subplots(figsize = (8,6))
sns.heatmap(conf_mat, annot = True, fmt = 'd',
            xticklabels = agility.values, yticklabels = agility.values)
plt.ylabel('Actual')
plt.xlabel('Predicted')
plt.title('Original Dataset LogisticAT')
plt.show()

print('==================================================================')
print('Mean Absolute Error of LogisticAT',
      metrics.mean_absolute_error(y_pred_o, y_test))

print(metrics.classification_report(y_test, y_pred_o, target_names = datascrape['agility'].astype(str).unique().sort()))

# Creating and evaluating an ordinal regression model LogisticIT (Immediate-Threshold variant)

regressor = mord.LogisticIT(alpha = 1.)
regressor.fit(X_train, y_train_64)
y_pred_o = regressor.predict(X_test)
...
plt.ylabel('Actual')
plt.xlabel('Predicted')
plt.title('Original Dataset LogisticIT')
plt.show()
...
# Creating and evaluating an ordinal regression model LogisticSE (Squared Error variant)

regressor = mord.LogisticSE(alpha = 1.)
regressor.fit(X_train, y_train_64)
y_pred_o = regressor.predict(X_test)
...
plt.ylabel('Actual')
plt.xlabel('Predicted')
plt.title('Original Dataset LogisticSE')
plt.show()
...
# Creating and evaluating an ordinal regression model OrdinalRidge

regressor = mord.OrdinalRidge(alpha = 1.)
regressor.fit(X_train, y_train_64)
y_pred_o = regressor.predict(X_test)
...
plt.ylabel('Actual')
plt.xlabel('Predicted')
plt.title('Original Dataset Ordinal Ridge')
plt.show()

print('==================================================================')
print('Mean Absolute Error of OrdinalRidge',
      metrics.mean_absolute_error(y_pred_o, y_test))

print(metrics.classification_report(y_test, y_pred_o, target_names = datascrape['agility'].astype(str).unique().sort()))

# Creating and evaluating an ordinal regression model LAD (Least Absolute Deviation)
...
plt.ylabel('Actual')
plt.xlabel('Predicted')
plt.title('Original Dataset LAD')
plt.show()

print('==================================================================')
print('Mean Absolute Error of LAD',
      metrics.mean_absolute_error(y_pred_o, y_test))
